...
sudo -u railsapp -H bundle exec rake assets:precompile RAILS_ENV="production"

cat gcloud/default-nginx > /etc/nginx/sites-available/default
systemctl restart nginx.service

cat gcloud/railsapp.service > /lib/systemd/system/railsapp.service
systemctl enable railsapp.service
systemctl start railsapp.service

#cat gcloud/resqworker.service > /lib/systemd/system/resqworker.service
